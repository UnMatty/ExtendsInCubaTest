package com.company.extendsincubatest;
...
public class ExtendsincubatestTestContainer extends TestContainer {

    public ExtendsincubatestTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/company/extendsincubatest/app.properties",
    ...
    public static class Common extends ExtendsincubatestTestContainer {

        public static final ExtendsincubatestTestContainer.Common INSTANCE = new ExtendsincubatestTestContainer.Common();
